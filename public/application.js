...
var onGetGames = function onGetGames(event) {
  ...
  gamesApi.getGames().then(gamesUi.gameOnSuccess).catch(gamesUi.gameOnError);
};
...
var onUpdateGame = function onUpdateGame(event) {
  ...
  gamesApi.updateGame(data).then(gamesUi.gameOnUpdateSuccess).catch(gamesUi.gameOnError);
...
var onCreateGame = function onCreateGame(event) {
  ...
  var data = getFormFields(event.target);
  gamesApi.createGame(data).then(gamesUi.gameOnPostSuccess).catch(gamesUi.gameOnError);
...
var onClickGameBoard = function onClickGameBoard(event) {
  ...
  var gameIsOver = function gameIsOver() {
    if (game[0] === 'X' && game[4] === 'X' && game[8] === 'X' || game[2] === 'X' && game[4] === 'X' && game[6] === 'X' || game[0] === 'X' && game[1] === 'X' && game[2] === 'X' || game[3] === 'X' && game[4] === 'X' && game[5] === 'X' || game[6] === 'X' && game[7] === 'X' && game[8] === 'X' || game[0] === 'X' && game[3] === 'X' && game[6] === 'X' || game[1] === 'X' && game[4] === 'X' && game[7] === 'X' || game[2] === 'X' && game[5] === 'X' && game[8] === 'X') {
    ...
    } else if (game[0] === 'O' && game[4] === 'O' && game[8] === 'O' || game[2] === 'O' && game[4] === 'O' && game[6] === 'O' || game[0] === 'O' && game[1] === 'O' && game[2] === 'O' || game[3] === 'O' && game[4] === 'O' && game[5] === 'O' || game[6] === 'O' && game[7] === 'O' && game[8] === 'O' || game[0] === 'O' && game[3] === 'O' && game[6] === 'O' || game[1] === 'O' && game[4] === 'O' && game[7] === 'O' || game[2] === 'O' && game[5] === 'O' && game[8] === 'O') {
  ...
  if (gameIsOver()) {
    ...
    return false;
  } else if (game[$(this).attr('id')] === player1 || game[$(this).attr('id')] === player2) {
...
var gameOnSuccess = function gameOnSuccess(data) {
  if (data.game) {
...
var gameOnError = function gameOnError(response) {
  console.error(response);
};

var gameOnUpdateSuccess = function gameOnUpdateSuccess(data) {
  console.log(data);
  console.log('You successfully updated the game!');
};

var gameOnPostSuccess = function gameOnPostSuccess(data) {
...
module.exports = {
  gameOnSuccess: gameOnSuccess,
  gameOnError: gameOnError,
  gameOnUpdateSuccess: gameOnUpdateSuccess,
  gameOnPostSuccess: gameOnPostSuccess
};
